...
-- SUPER key with MMB to toggle rofi
hl.bind(mainMod .. " + mouse:274", hl.dsp.exec_cmd("~/.config/hypr/scripts/launcher.sh"), { mouse = true, description = "Toggle application launcher" })
...
hl.bind("CTRL + SHIFT + escape", hl.dsp.exec_cmd("/usr/bin/missioncenter"), { description = "Open the task manager"})
